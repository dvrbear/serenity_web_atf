...
public class ConstXpath {
    ...
    public static String SIGNIN_XPATH = "//input[@value='Sign in']";
    public static String WORKPLACE_XPATH = "//*[@path='/booking/workplace']";
    public static String ZTOWER_XPATH = "//span[text()='ZTower']";
    public static String KITCHEN_XPATH = "//span[text()='chen}']";
